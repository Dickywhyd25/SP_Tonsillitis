...
$kdpenyakit=$_GET['id_problem']; $queryP=mysql_query("SELECT * FROM tb_penyakit WHERE id='$kdpenyakit' "); $dataP=mysql_fetch_array($queryP); echo $dataP['kdpenyakit']."|".$dataP['nama_penyakit'];
?>
...
<table width="700" border="0" cellpadding="4" cellspacing="1" bordercolor="#F0F0F0" >
  <tr style="background:linear-gradient(to top, #9C0, #CF0);">
    ...
    <?php
    $query=mysql_query(" SELECT * FROM tb_gejala WHERE id='$_GET[id_evidence]' ")or die(mysql_error());
