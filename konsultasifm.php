<html>
<title>PakarGigi|DS</title>
<body>
<?php include "koneksi2.php"; ?>
<table width="750" border="1" align="center">
  <tr>
    <td width="786"><h3>PROSES DIAGNOSA PENYAKIT Tonsillitis</h3><strong>Pilihlah Gejala Yang Anda Alami..!</strong></td>
  </tr>
  <tr>
    <td>
<form method="post" >
...
if(isset($_POST['evidence'])){
	if(count($_POST['evidence'])<2){
		...
		foreach($arrKDGejalaSelect as $kdGSelect){ 
			echo $kdGSelect." | ";
			$queryG=mysql_query("SELECT * FROM tb_gejala WHERE id='$kdGSelect' ORDER BY id ASC"); 
		...
		$sql = "SELECT GROUP_CONCAT(b.kdpenyakit), a.cf, a.id_evidence
			...
			JOIN tb_gejala c ON a.id_evidence=c.id
...
<?php	
$arrPenyakit=array(); 
$queryPasien=mysql_query("SELECT * FROM tbpasien ORDER BY idpasien ASC"); $dataPasien=mysql_fetch_array($queryPasien);
